...
struct Colors
{
    ...
    std::pair<float, glm::vec3> darkWater{0.0f, {84, 153, 207}};
    std::pair<float, glm::vec3> lightWater{0.3f, {116, 200, 194}};
    std::pair<float, glm::vec3> foam{0.35f, {235, 223, 152}};
    std::pair<float, glm::vec3> sand{0.4f, {235, 223, 152}};
    std::pair<float, glm::vec3> dirt{0.8f, {228, 160, 161}};
